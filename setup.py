...
setup(
    name='topology_lib_files_management',
    version=find_version('lib/topology_lib_files_management/__init__.py'),
    package_dir={'': 'lib'},
    ...
    # Metadata
    author='maria alas',
    author_email='maria.alas@hpe.com',
    description=(
        'This library will have every command related with files management'
    ),
    long_description=read('README.rst'),
    url='https://github.com/maralas/topology_files_management/tree/master/doc',
    keywords='topology_lib_files_management',
    ...
    entry_points={
        'topology_library_10': [
            'files_management = topology_lib_files_management.library'
        ]
    }
)
